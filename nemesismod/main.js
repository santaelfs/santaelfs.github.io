...
function setupScene() {
	...
	var materials = [
	                 new t.MeshLambertMaterial({/*color: 0x00CCAA,*/map: t.ImageUtils.loadTexture('"C:\Users\qeicorp02\Desktop\IceCreamYou-Nemesis-db9453a\images\wall-1.jpg"')}),
	                 new t.MeshLambertMaterial({/*color: 0xC5EDA0,*/map: t.ImageUtils.loadTexture('"C:\Users\qeicorp02\Desktop\IceCreamYou-Nemesis-db9453a\images\wall-2.jpg"')}),
	...
	healthcube = new t.Mesh(
			...
			new t.MeshBasicMaterial({map: t.ImageUtils.loadTexture('"C:\Users\qeicorp02\Desktop\IceCreamYou-Nemesis-db9453a\images\health.png"')})
	);
